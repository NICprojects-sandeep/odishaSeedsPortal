...
@Component({
  selector: 'app-statestockpostion',
  templateUrl: './statestockpostion.component.html',
  styleUrls: ['./statestockpostion.component.css']
})
export class StatestockpostionComponent implements OnInit {
