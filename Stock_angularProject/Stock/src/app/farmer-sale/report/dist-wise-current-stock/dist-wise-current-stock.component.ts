...
@Component({
  selector: 'app-dist-wise-current-stock',
  templateUrl: './dist-wise-current-stock.component.html',
  styleUrls: ['./dist-wise-current-stock.component.css']
})
export class DistWiseCurrentStockComponent implements OnInit {
                ...
                targetArrays.forEach((targetArray: any) => {
                  ...
                  if (!existsInTarget) {
                    const newVariety = {
                      ...item,
                      STOCK: 0,
                      Godown_Name: targetArray[0].Dist_Name,
                      Godown_ID: targetArray[0].Dist_Code,
                    };
                    targetArray.push(newVariety);
                    foundInAnyArray = true;
                  }
