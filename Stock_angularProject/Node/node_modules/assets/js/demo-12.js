...
function loadDetails() {
	...
	$(document).ready(function () {
		...
		$("#pcoded").pcodedmenu({
			...
			verticalMenueffect: { desktop: o, tablet: u, phone: i, },
		...
		function c() {
			$(".theme-color > a.navbg-pattern").on("click",
				function () { var C = $(this).attr("navbg-pattern"); $(".pcoded").attr("sidebar-img-type", C) })
		};
		c();
		function a() {
			$(".theme-color > a.Layout-type").on("click", function () {
				...
				if (C == "dark") {
					...
					$(".pcoded").attr("sidebar-img", "false"); $("body").addClass("dark");
					$("body").attr("themebg-pattern", "theme6"); $(".pcoded-navigation-label").attr("menu-title-theme", "theme9")
				}
				if (C == "light") {
					...
					$("body").removeClass("dark"); $("body").attr("themebg-pattern", "theme1")
				}
				if (C == "img") {
					$(".pcoded-header").attr("header-theme", "theme1");
					$(".pcoded-navbar").attr("navbar-theme", "themelight1");
		...
		function t() {
			$(".theme-color > a.navbar-theme").on("click", function () {
				var C = $(this).attr("navbar-theme"); $(".pcoded-navbar").attr("navbar-theme", C);
				$(".pcoded").attr("sidebar-img", "false");
				if (C == "themelight1") { $(".pcoded-navigation-label").attr("menu-title-theme", "theme1") }
				if (C == "theme1") { $(".pcoded-navigation-label").attr("menu-title-theme", "theme9") }
			})
		};
		t();
		function k() {
			$(".theme-color > a.active-item-theme").on("click", function () {
				var C = $(this).attr("active-item-theme"); $(".pcoded-navbar").attr("active-item-theme", C)
			})
		};
		k();
		function y() {
		...
		function w() {
			$("#theme-layout").change(function () { if ($(this).is(":checked")) { $(".pcoded").attr("vertical-layout", "box"); $("#bg-pattern-visiblity").removeClass("d-none") } else { $(".pcoded").attr("vertical-layout", "wide"); $("#bg-pattern-visiblity").addClass("d-none") } })
		} w(); function n() {
			$("#vertical-menu-effect").val("shrink").on("change",
				function (C) { C = $(this).val(); $(".pcoded").attr("vertical-effect", C) })
		} n();
		function s() {
			$("#vertical-border-style").val("solid").on("change",
				function (C) { C = $(this).val(); $(".pcoded-navbar .pcoded-item").attr("item-border-style", C) })
		} s();
		function v() {
			$("#vertical-dropdown-icon").val("style1").on("change",
				function (C) { C = $(this).val(); $(".pcoded-navbar .pcoded-hasmenu").attr("dropdown-icon", C) })
		} v();
		function z() {
			$("#vertical-subitem-icon").val("style5").on("change",
				function (C) { C = $(this).val(); $(".pcoded-navbar .pcoded-hasmenu").attr("subitem-icon", C) })
		} z();
		function g() {
		...
		function A() {
			$("#header-position").change(function () {
				if ($(this).is(":checked")) {
					...
					$(".pcoded-navbar").attr("pcoded-header-position",
						"relative"); $(".pcoded-main-container").css("margin-top", "0px")
				}
			})
		} A();
		function j() {
