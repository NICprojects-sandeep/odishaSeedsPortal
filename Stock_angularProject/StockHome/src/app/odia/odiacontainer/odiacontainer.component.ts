...
@Component({
  selector: 'app-odiacontainer',
  templateUrl: './odiacontainer.component.html',
  styleUrls: ['./odiacontainer.component.css']
})
export class OdiacontainerComponent implements OnInit {
  getSeason: any = [];
  crops: any = [];
  varieties: any = [];
  districts: any = [];
  ...
  loadSeason() {
    this.service.loadSeason(this.year).subscribe(async result => {
      ...
      console.log(result.cropSeason,'result.cropSeason');
