...
@Component({
  selector: 'app-odiaseedsupport',
  templateUrl: './odiaseedsupport.component.html',
  styleUrls: ['./odiaseedsupport.component.css']
})
export class OdiaseedsupportComponent implements OnInit {
  Varieties: any;
  VarietyNames = [];
  StockValues = [];
  districtList: any;
