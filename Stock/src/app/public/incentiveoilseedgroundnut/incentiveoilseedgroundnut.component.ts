...
@Component({
  selector: 'app-incentiveoilseedgroundnut',
  templateUrl: './incentiveoilseedgroundnut.component.html',
  styleUrls: ['./incentiveoilseedgroundnut.component.css']
})
export class IncentiveoilseedgroundnutComponent implements OnInit {
