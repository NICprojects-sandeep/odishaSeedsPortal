...
public partial class MasterPages_SE4 : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (base.Session["UserType"].ToString().Trim() == "FOUR")
        {
            this.Mhome.NavigateUrl = "../Reports/Transaction_Accp.aspx";
        }
        else
        {
            //base.Response.Redirect("DeptHome.aspx", false);
