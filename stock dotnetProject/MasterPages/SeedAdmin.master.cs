...
public partial class MasterPages_SeedAdmin : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["Name"] != null || Session["UserType"] != null)
        {
            ...
            if (base.Session["UserType"].ToString().Trim() == "SEAD")
            {
                this.Mhome.NavigateUrl = "../Admin/SeedAdminHome.aspx";
            }
            else
            {
                //base.Response.Redirect("DeptHome.aspx", false);
