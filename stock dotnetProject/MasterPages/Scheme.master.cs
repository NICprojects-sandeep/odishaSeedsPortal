...
public partial class MasterPages_Scheme : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (base.Session["UserType"].ToString().Trim() == "NFSM")
        {
            this.Mhome.NavigateUrl = "../Admin/SchemeHome.aspx";
        }
        else if (base.Session["UserType"].ToString().Trim() == "RKVY")
        {
            this.Mhome.NavigateUrl = "../Admin/SchemeHome.aspx";
        }
        else if (base.Session["UserType"].ToString().Trim() == "NMAD")
        {
            this.Mhome.NavigateUrl = "../Admin/SchemeHome.aspx";
        }
        else if (base.Session["UserType"].ToString().Trim() == "SPAD")
        {
            this.Mhome.NavigateUrl = "../Admin/SchemeHome.aspx";
        }
        else
