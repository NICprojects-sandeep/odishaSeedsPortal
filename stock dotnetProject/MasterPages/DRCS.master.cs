...
public partial class MasterPages_DRCS : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["Name"] != null)
        {
            ...
            else if (base.Session["UserType"].ToString().Trim() == "DRCS")
            {
                this.Mhome.NavigateUrl = "../Admin/DRCSHome.aspx";
            }
            else if (base.Session["UserType"].ToString().Trim() == "DIST")
            {
                this.Mhome.NavigateUrl = "../Admin/DistHome.aspx";
            }
            else
            {
                //base.Response.Redirect("DeptHome.aspx", false);
