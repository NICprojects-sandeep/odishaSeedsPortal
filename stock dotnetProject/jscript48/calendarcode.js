...
var img_close;
img_del=new Image();
img_del.src="./jscript48/btn_del_small.gif";
img_close=new Image();
img_close.src="./jscript48/btn_close_small.gif";
minYearList=todayDate.getFullYear()-25;
maxYearList=todayDate.getFullYear()+25;
IsCalendarVisible=false;
img_Date_UP=new Image();
img_Date_UP.src="./jscript48/btn_date_up.gif";
img_Date_OVER=new Image();
img_Date_OVER.src="./jscript48/btn_date_over.gif";
img_Date_DOWN=new Image();
img_Date_DOWN.src="./jscript48/btn_date_down.gif";
...
function Calendar(whatMonth,whatYear) {
    ...
    output += '<td class="cal-HeadCell" align="center" width="100%"><a href="javascript:clearDay();"><img name="calbtn1" src="./jscript48/btn_del_small.gif" border="0" width="12" height="10"></a>  <a href="javascript:scrollMonth(-1);" class="cal-DayLink"><</a> <SELECT class="cal-TextBox" NAME="cboMonth" onChange="changeMonth();">';
    ...
    output += '<\/SELECT> <a href="javascript:scrollMonth(1);" class="cal-DayLink">></a>  <a href="javascript:hideCalendar();"><img name="calbtn2" src="./jscript48/btn_close_small.gif" border="0" width="12" height="10"></a><\/td><\/tr><tr><td width="100%" align="center">';
...
function clearDay() {
    eval('document.getElementById("' + curDateBox + '").value = \'\'');
    hideCalendar();
    if (FuncsToRun!=null)
        eval(FuncsToRun); 
}
function changeDay(whatDay) {
    ...
    eval('document.getElementById("' + curDateBox + '")' +'.value = "'+ padout(curDate.getDate()) + '-' + names[curDate.getMonth()] + '-' + curDate.getFullYear() + '"');
    hideCalendar();
    if (FuncsToRun!=null)
        eval(FuncsToRun); 
}
