<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AAO.master" AutoEventWireup="true" CodeFile="RPT_AAOVarietyWiseSale.aspx.cs" Inherits="Reports_RPT_AAOVarietyWiseSale" %>
                        ...
                        <div style="background-color: #FFF; padding: 10px; width: 1200px;">
                            <table style="width: 100%; padding: 0px;" class="tabletxt" cellpadding="10" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td class="normaltd" colspan="6">From Date<span class="mandatory">*</span>:<asp:TextBox ID="txtfromdate" Width="100px" runat="server" CssClass="TextboxCss"></asp:TextBox>
