...
public partial class Reports_RPT_DealerPacksRcv : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        string sql = "STOCK_RPT_DealerPacksReceive";
    ...
    private void GenerateReport(DataSet ds)
    {
        ...
        foreach (DataRow dr in ds.Tables[0].Rows)
        {
            ...
            foreach (DataRow drv in dtVariety.Rows)
            {
                ...
                DataRow[] DataPack = ds.Tables[1].Select("Dist_Code= " + dr["Dist_Code"].ToString() + " AND CROP_VERID = '" + drv["CROP_VERID"].ToString() + "'");
