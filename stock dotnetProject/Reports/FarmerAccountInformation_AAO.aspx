<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AAO_.master" AutoEventWireup="true" CodeFile="FarmerAccountInformation_AAO.aspx.cs" Inherits="Reports_FarmerAccountInformation_AAO" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnDetails').click(function () {
                ...
                $.ajax({
                    url: 'FarmerAccountInformation_AAO.aspx/GetFarmerDetails',
                    type: 'GET',
                    ...
                    success: function (data) {
                        ...
                        if (data.d != null) {
                            ...
                            $('#tblFarmerInformation').append('<tr><th>Farmer Name</th><th>Father Name</th><th>District</th><th>Block</th><th>GP</th><th>Village</th><th>Mobile No</th><th>Voter ID</th></tr>');
                    ...
                    success: function (data) {
                        if (data.d != null) {
                            ...
                            if (data.d.status == "ACCP" || data.d.status == "CCB") {
                                ...
                                $.ajax({
                                    url: 'FarmerAccountInformation_AAO.aspx/GetCount',
                                    type: 'GET',
        ...
        <fieldset style="margin-top: 20px; width: 90%; margin-left: 100px">
            ...
            <div style="margin-top: 20px">
                <div class="col-sm-12" id="divApprove">
                    ...
                    <span id="spanAAOAAO1" class="hideMe" style="font-size: 15px; margin-top: 40px">Pending For AAO Approval.</span>
