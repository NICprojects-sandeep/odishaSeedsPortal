...
public partial class Reports_Rpt_Current_Stock : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        string[] param = { "@FIN_YR", "@User_Type", "@CropCatg_ID", "@Crop_ID", "@Session" };
        object[] value = { drpSession.SelectedValue.Trim(), drpUser.SelectedValue.Trim(), drpCropCatagory.SelectedValue.Trim(), drpCropName.SelectedValue.Trim(),
                             drpSeassion.SelectedValue.Trim() == "0" ? System.Convert.DBNull
