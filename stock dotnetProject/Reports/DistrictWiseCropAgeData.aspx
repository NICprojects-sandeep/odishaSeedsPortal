<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.master" AutoEventWireup="true" CodeFile="DistrictWiseCropAgeData.aspx.cs" Inherits="Reports_DistrictWiseCropAgeData" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <div class="titleHeader">
        &nbsp; DistrictWise Crop AgeWise Sale Details
    </div>
     <br />
    <script>
                ...
                <div style="width: 1220px; padding: 2px; margin: 0 auto;">
                    ...
                    <div id="divPrint">
                        <table style="width:100%;">
                            <tr>
                                <td style="width:50%;"><asp:Literal ID="littime" runat="server" Text="SCHEMEWISE DETAILS as on"></asp:Literal></td>
