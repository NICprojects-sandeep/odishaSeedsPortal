<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SeedAdmin.master" AutoEventWireup="true" CodeFile="RPT_Schemewise1.aspx.cs" Inherits="Reports_RPT_Schemewise1" %>
            ...
            <asp:Panel ID="Panel1" runat="server" Style="padding-top: 30px;" CssClass="tbltxt">
                <div style="width: 1220px; padding: 2px; margin: 0 auto;">
                    ...
                    <div id="divPrint">
                        ...
                        NB: Total Seed sold excludes seeds sold to unregistered farmers.
                    </div>
                        </div>
                </fieldset>
                </div>
