<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AAO_.master" AutoEventWireup="true" CodeFile="AAOFarmerListNew.aspx.cs" Inherits="Reports_AAOFarmerListNew" %>
    ...
    <asp:UpdatePanel ID="updatepanel" runat="server" UpdateMode="Always">
        <ContentTemplate>
            <div style="width: 100%; padding:10px;">
                <strong><em>
                    <asp:Literal ID="Literal1" runat="server" Text="NEWLY GENERATED FARMER IDS"></asp:Literal></em></strong>
            </div>
                ...
                <fieldset class="tbl">
                    ...
                    <table style="width: 90%; padding: 15px;">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="drpGp" runat="server" AutoPostBack="True"  Width="150px" OnSelectedIndexChanged="drpGp_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
