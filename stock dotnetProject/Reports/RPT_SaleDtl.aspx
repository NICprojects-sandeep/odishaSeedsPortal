<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/STOCK.master" AutoEventWireup="true" CodeFile="RPT_SaleDtl.aspx.cs" Inherits="Reports_RPT_SaleDtl" %>
                    ...
                    <div style="background-color: #FFF; padding: 10px; width: 1280px;">
                        <table style="width: 100%; padding: 10px;" class="tabletxt">
                            <tr>
                                ...
                                <td style="width: 94px;" class="normaltd">Select Godown</td>
                                <td style="width: 5px;">:</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox ID="txtToDt" CssClass="TextboxCss" runat="server"></asp:TextBox>
