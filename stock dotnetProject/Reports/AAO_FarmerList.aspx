<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AAO_.master" AutoEventWireup="true" CodeFile="~/Reports/AAO_FarmerList.aspx.cs" Inherits="AAO_Farmer_FarmerList" %>
            ...
            <table style="width: 90%; padding: 15px;">
                <tr>
                    ...
                    <td style="width: 250px;">
                        ...
                        <asp:HiddenField ID="hfDistCode" runat="server" />
                    </td>
