<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RPT_VarietyWiseSaleDistWIse.aspx.cs" Inherits="Reports_RPT_VarietyWiseSaleDistWIse" %>
    ...
    <div>
            ...
            <asp:Panel ID="pnlPrintArea" runat="server" Width="100%">
                <fieldset class="tbl">
                    ...
                    <legend style="margin-left: 10px; font-weight: bold;">District Wise VarietySale</legend>
