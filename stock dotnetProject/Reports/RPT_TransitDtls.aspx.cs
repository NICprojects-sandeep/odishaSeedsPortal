...
public partial class Reports_RPT_TransitDtls : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        OSCCDTLS();
    }
    private void OSCCDTLS()
    {
        ...
        string sql = "STOCK_RPT_CropwiseStockPendingOSSC";
    ...
    //    try
    //    {
    //        string attachment = "attachment; filename=OSSC_TransitDTLS.xls";
