...
public partial class Reports_RptSchmVrtyAge : System.Web.UI.Page
{
    ...
    private void GenerateReport1(DataSet ds)
    {
        ...
        foreach (DataRow dr in scheem.Rows)
        {
            ...
            if (pscsDistQtl.Length > 0)
            {
                ...
                {
                    QTLPACS = Convert.ToDecimal(value[3].ToString());
                    if ((dr["SCHEME"].ToString() == "NFSM") || (dr["SCHEME"].ToString() == "RKVY"))
                    {
                        if (QtlA.Length > 0)
                        {
                            foreach (DataRow rowQtlA in QtlA)
                            {
                                str.Append(" <td style='text-align: Right; padding-right:5px;'>" + rowQtlA[1].ToString() + "</td>");
                                QTLPACS = Convert.ToDecimal(rowQtlA[1].ToString());
                            }
                        }
                        //if (dr["SCHEME"].ToString() == "NFSM")
                        //{
                        //    str.Append(" <td style='text-align: Right; padding-right:5px;'>12600</td>");
                        //    nfsm1a = QTLPACS;
                        //}
                        //else if (dr["SCHEME"].ToString() == "RKVY")
                        //{
                        //    str.Append(" <td style='text-align: Right; padding-right:5px;'>20000</td>");
                        //    rkvy1a = QTLPACS;
                        //}
                        //else
                        //{
                ...
                foreach (DataRow value in DealDistQtl)
                {
                    ...
                    if ((dr["SCHEME"].ToString() == "NFSM") || (dr["SCHEME"].ToString() == "RKVY"))
                    {
                        if (QtlB.Length > 0)
                        {
                            ...
                            {
                                str.Append(" <td style='text-align: Right; padding-right:5px;'>" + rowQtlB[1].ToString() + "</td>");
                                QtlDealer = Convert.ToDecimal(rowQtlB[1].ToString());
                            }
                        }
                    }
                    else
        ...
        //                        QTLPACS = 20000;
        //                        str.Append(" <td style='text-align: Right; padding-right:5px;'>20000.00</td>");
        //                    }
        //                }
        //            }
        //            else
        ...
        //                        SubPACS = 20000000;
        //                        str.Append(" <td style='text-align: Right; padding-right:5px;'>20000000.00</td>");
        //                    }
        //                }
        //            }
        //            else
    ...
    {
        DataSet ds = new DataSet();
        string sql = "STOCK_SCHEMEWISE_RPT3";
