<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.master" AutoEventWireup="true" CodeFile="OSSCIncentive.aspx.cs" Inherits="Reports_OSSCIncentive" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">    
    ...
    <asp:GridView ID="gvIncentive" runat="server" AutoGenerateColumns="False" ShowFooter="True">
        <Columns>
            ...
            <asp:BoundField DataField="INSPECTED_AREA" HeaderText="Inspected Area  (in Hectare)" />
            <asp:BoundField DataField="SUBSIDISED_AREA" HeaderText="Subsidised Area (in Hectare)" />
