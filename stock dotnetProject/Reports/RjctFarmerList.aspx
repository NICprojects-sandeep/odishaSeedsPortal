<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Dist.master" AutoEventWireup="true" CodeFile="RjctFarmerList.aspx.cs" Inherits="Reports_RjctFarmerList" %>
            ...
            <ContentTemplate>
                ...
                <asp:GridView ID="grd_FarmerList" runat="server" BackColor="#B2C629"
                    ...
                    <ItemTemplate>
                        ...
                        <asp:Label ID="lbl_VCHVOTERIDCARDNO" runat="server" Text='<%#Eval("VCHVOTERIDCARDNO")%>'></asp:Label>
                    </ItemTemplate>
                    ...
                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                       ...
                       <asp:TemplateField HeaderText="SL NO." HeaderStyle-HorizontalAlign="Left">
                        ...
                        <asp:TemplateField HeaderText="PFMS Status" HeaderStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                <asp:Label ID="lbl_Category_Value" runat="server" Text='<%#Eval("Beneficiary_Status")%>'></asp:Label>
                            </ItemTemplate>
