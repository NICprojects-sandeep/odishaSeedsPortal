<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Finance.master" AutoEventWireup="true" CodeFile="RPTPaymentOSSC.aspx.cs" Inherits="Reports_RPTPaymentOSSC" %>
                    ...
                    <td style="width: 40%;">
                        <table style="width: 100%;">                            
                            <tr>
                                <td align="center">
                                    <br />
                                    <asp:GridView ID="gvRequest" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                                        AutoGenerateColumns="False" CellSpacing="2" Style="height: 138px" OnRowCommand="gvRequest_RowCommand">
                                        ...
                                        <Columns>  
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <asp:Button ID="btnUpdate" runat="server" CommandName="Up" CommandArgument="<%# Container.DataItemIndex %>"  Text="Approve"/>
                                                        <asp:Label ID="lblCPAID1" runat="server" Text='<%#Eval("CPAID") %>' Visible="false"></asp:Label>
                                                </ItemTemplate>
                                                </asp:TemplateField>
