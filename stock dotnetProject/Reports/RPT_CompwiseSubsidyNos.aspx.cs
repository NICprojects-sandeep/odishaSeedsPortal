...
using System.Text;
using System.Web.UI;
public partial class Reports_RPT_CompwiseSubsidyNos : System.Web.UI.Page
{
    ...
    {
        DataSet ds = new DataSet();
        string sql = "STOCK_CompwiseSubsidyNos";
    ...
    private void GenerateReport(DataSet ds)
    {
        ...
        str.Append(" <td style='text-align: center; padding-right:5px;' colspan='5'>Total</td>");
        str.Append("</tr>");
        ...
        foreach (DataRow dr in dtCrop.Rows)
        {
            ...
            str.Append(" <td style='text-align: Right; padding-right:5px;'>Unassigned Farmers</td>");
        ...
        foreach (DataRow dr in ds.Tables[0].Rows)
        {
            ...
            foreach (DataRow drv in dtCrop.Rows)
            {
                ...
                str.Append(" <td style='text-align: Right; padding-right:5px;'>" + (UnRegFarmer + RegdFarmer) + "</td>");
