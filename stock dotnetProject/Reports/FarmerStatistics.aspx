<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.master" AutoEventWireup="true" CodeFile="FarmerStatistics.aspx.cs" Inherits="Reports_FarmerStatistics" %>
...
<asp:TemplateField HeaderText="Sl No." HeaderStyle-HorizontalAlign="Left"> <ItemTemplate> <%#Container.DataItemIndex+1 %> </ItemTemplate> </asp:TemplateField>
                <asp:TemplateField HeaderText="Voter Id" HeaderStyle-HorizontalAlign="Left">
                    <ItemTemplate>
                        ...
                        <asp:LinkButton ID="lnkVCard" runat="server" Text='<%#Eval("VCHVOTERIDCARDNO")%>' CausesValidation="false" OnClientClick="aspnetForm.target ='_blank';"></asp:LinkButton>
                    </ItemTemplate>
