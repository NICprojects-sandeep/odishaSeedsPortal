<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Dist.master" AutoEventWireup="true" CodeFile="Rpt_DistwiseCurrent_Stock.aspx.cs" Inherits="Reports_Rpt_DistwiseCurrent_Stock" %>
                    ...
                    <div style="background-color: #FFF; padding: 10px; overflow: scroll; width: 1200px;">
                        <table style="width: 100%; padding: 10px;" class="tabletxt">
                            ...
                            <tr>
                                ...
                                <td>Crop Catagory<span class="mandatory">*</span></td>
                                <td>:</td>
                                <td>
