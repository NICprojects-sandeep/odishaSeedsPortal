...
public partial class Reports_DistwiseVarietySearch : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        object[] value = { Session["DistName"].ToString().Substring(0, 3), drpCropName.SelectedValue.Trim(), drpCropVar.SelectedValue.Trim() };
