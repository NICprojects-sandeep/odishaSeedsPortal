<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.master" AutoEventWireup="true" CodeFile="RPT_OAICStockReport.aspx.cs" Inherits="Reports_RPT_OAICStockReport" %>
                ...
                <div style="width: 1200px; background-color: #666; padding: 2px; margin: 0 auto;">
                    <div style="background-color: #FFF; padding: 10px; overflow: scroll; width: 1200px;">
                        ...
                        <fieldset class="tbl">
                            ...
                            <legend style="margin-left: 10px; font-weight: bold;">Userwise Stock(OAIC)</legend>
