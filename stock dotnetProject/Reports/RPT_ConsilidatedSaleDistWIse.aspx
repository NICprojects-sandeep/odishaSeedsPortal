<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RPT_ConsilidatedSaleDistWIse.aspx.cs" Inherits="Reports_RPT_ConsilidatedSaleDistWIse" %>
  ...
  <div>
            ...
            <asp:Panel ID="pnlPrintArea" runat="server" Width="100%">
                <fieldset class="tbl">
                    ...
                    <legend style="margin-left: 10px; font-weight: bold;">District Wise ConsolidatedSale</legend>
