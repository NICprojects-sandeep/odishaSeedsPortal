<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SeedAdmin.master" AutoEventWireup="true" CodeFile="PaymentCheck.aspx.cs" Inherits="Reports_PaymentCheck" %>
                ...
                <tr>
                    ...
                    <br />
                        <asp:GridView ID="gvdlrrpt" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                            ...
                            Style="height: 138px" ShowFooter="true">
