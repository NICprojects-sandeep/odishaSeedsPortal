...
public partial class Reports_RPTPaymentOSSC : System.Web.UI.Page
{
    ...
    private void FillRequest()
    {
        try
        {
            ...
            ds = new DataSet();
            ds = objUserDLL.FillDealerRequestOSSC();
            if (ds != null)
            {
    ...
    private void UpdateHdr(string CPAID)
    {
        try
        {
            ...
            objUserDLL = new DLL_DropDown();
            int i = objUserDLL.UpdateApprOSSC(objUserBEL);
            if (i > 0)
            {
                FillRequest();
            }
    ...
    private void generateReport(DataSet ds)
    {
        ...
        foreach (DataRow dr in dt.Rows)
        {
            ...
            str.Append("<td>Subsidy Amount</td>");
            str.Append("</tr>");
