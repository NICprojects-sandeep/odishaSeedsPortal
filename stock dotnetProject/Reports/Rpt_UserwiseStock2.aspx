<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.master" AutoEventWireup="true" CodeFile="Rpt_UserwiseStock2.aspx.cs" Inherits="Reports_Rpt_UserwiseStock2" %>
                ...
                <div style="width: 1200px; background-color: #666; padding: 2px; margin: 0 auto;">
                    <div style="background-color: #FFF; padding: 10px; overflow: scroll; width: 1200px;">
                        ...
                        <fieldset class="tbl">
                           ...
                           <i class="fa fa-truck" aria-hidden="true"></i>Transit, &nbsp;&nbsp;<i class="fa fa-star" aria-hidden="true" style="color:red;"></i>excess amount is carried over from the last seassion
