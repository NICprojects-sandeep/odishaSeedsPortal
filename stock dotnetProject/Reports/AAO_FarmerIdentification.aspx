<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Reports/AAO_FarmerIdentification.aspx.cs"
    Inherits="AAO_FarmerIdentification" %>
...
<body onload="Print();">
    <center>
        ...
        <div class="Border">
            <table width="100%" class="tbl" cellspacing="10px">
                <tr>
                    <td colspan="2" class="Header1">Department of Agriculture and Farmers' Empowerment <div style="float: right; padding-left: 20px; font-size: 14px; font-weight: bold;"><u>Duplicate</u></div>
                        <br />
                        Govt. of Odisha
