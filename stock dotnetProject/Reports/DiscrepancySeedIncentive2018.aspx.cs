...
public partial class Reports_DiscrepancySeedIncentive2018 : System.Web.UI.Page
{
    BLL_DropDown BAL;
    DLL_DropDown DAL;
    DataSet ds;
    ...
    private void GenerateReport(DataSet ds)
    {
        ...
        str.Append("<td style='text-align: Right;'>Inspected Area (in Acers)</td>");
        str.Append("<td style='text-align: Right;'>Subsidised Area (in Acers)</td>");
