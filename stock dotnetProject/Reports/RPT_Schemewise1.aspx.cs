...
public partial class Reports_RPT_Schemewise1 : System.Web.UI.Page
{
    ...
    private void GenerateReport1(DataSet ds)
    {
        ...
        str.Append("<td></td>");
        str.Append("<td style='text-align: Center;'>PACS</td>");
        str.Append("<td style='text-align: Center;'>Dealer</td>");
        ...
        foreach (DataRow dr in scheem.Rows)
        {
            ...
            DataRow[] pscsDistFarmer = ds.Tables[0].Select("SCHEME= '" + dr["SCHEME"].ToString() + "' and APP_TYPE='PACS'");
            ...
            DataRow[] DealDistFarmer = ds.Tables[0].Select("SCHEME= '" + dr["SCHEME"].ToString() + "' and APP_TYPE='DEALER'");
            ...
            DataRow[] pscsDistQtl = ds.Tables[0].Select("SCHEME= '" + dr["SCHEME"].ToString() + "' and APP_TYPE='PACS'");
            ...
            DataRow[] DealDistQtl = ds.Tables[0].Select("SCHEME= '" + dr["SCHEME"].ToString() + "' and APP_TYPE='DEALER'");
            ...
            DataRow[] pscsSub = ds.Tables[0].Select("SCHEME= '" + dr["SCHEME"].ToString() + "' and APP_TYPE='PACS'");
            if (pscsSub.Length > 0)
            {
            ...
            DataRow[] DealSub = ds.Tables[0].Select("SCHEME= '" + dr["SCHEME"].ToString() + "' and APP_TYPE='DEALER'");
            if (DealSub.Length > 0)
            {
            ...
            DataRow[] PACSSubs = ds.Tables[0].Select("SCHEME= '" + dr["SCHEME"].ToString() + "' and APP_TYPE='PACS'");
            ...
            DataRow[] DealSubs = ds.Tables[0].Select("SCHEME= '" + dr["SCHEME"].ToString() + "' and APP_TYPE='DEALER'");
        ...
        str.Append("<td style='text-align: Right;'>" + TotSoldPacs.ToString("N2") + "</td>");
        str.Append("<td style='text-align: Right;'>" + TotSoldDealer.ToString("N2") + "</td>");
        str.Append("<td style='text-align: Right;'>" + (Convert.ToDecimal(ds.Tables[0].Compute("Sum(TOT_QTL)", ""))).ToString("N2") + "</td>");
        str.Append("<td style='text-align: Right;'>" + TotSubPacs.ToString("N2") + "</td>");
        str.Append("<td style='text-align: Right;'>" + TotSubDealer.ToString("N2") + "</td>");
        str.Append("<td style='text-align: Right;'>" + (Convert.ToDecimal(ds.Tables[0].Compute("Sum(TOT_SUB)", ""))).ToString("N2") + "</td>");
        str.Append("<td style='text-align: Right;'>" + TotSubsPacs.ToString("N2") + "</td>");
        str.Append("<td style='text-align: Right;'>" + TotSubsDealer.ToString("N2") + "</td>");
        str.Append("<td style='text-align: Right;'>" + (Convert.ToDecimal(ds.Tables[0].Compute("Sum(RESAMOUNT)", ""))).ToString("N2") + "</td>");
        str.Append("</tr>");
        //str.Append("<tr>");
        //str.Append("<td colspan='4' style='font-weight:bold;'>Total Distinct Farmer irrespective of schemes  : " + ds.Tables[1].Rows[0][0].ToString() + "</td>");
        //str.Append("</tr>");
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        string sql = "STOCK_SCHEMEWISE_RPT1";
