...
public partial class Reports_RPT_VarietyWiseSale : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        string sql = "STOCK_RPT_SaleVarietywise";
        ...
        objUserDLL = new DLL_DropDown();
        ds = new DataSet();
        ds = objUserDLL.STOCK_RPT_SaleVarietywise(objUserBEL);
    ...
    private void GenerateReport(DataSet ds)
    {
        ...
        foreach (DataRow dr in ds.Tables[0].Rows)
        {
            ...
            DataRow[] NoofFarmergen = ds.Tables[3].Select("Dist_Code= " + dr["Dist_Code"].ToString() + "");
            ...
            DataRow[] NoofFarmersc = ds.Tables[4].Select("Dist_Code= " + dr["Dist_Code"].ToString() + "");
            ...
            DataRow[] NoofFarmerst = ds.Tables[5].Select("Dist_Code= " + dr["Dist_Code"].ToString() + "");
            ...
            DataRow[] uNoofFarmer = ds.Tables[6].Select("Dist_Code= " + dr["Dist_Code"].ToString() + "");
        ...
        str.Append("<td style='text-align: Right; padding-right:5px;' >" + ds.Tables[3].Compute("Sum(NoofFarmergen)", "").ToString() + "</td>");        
        str.Append("<td style='text-align: Right; padding-right:5px;' >" + ds.Tables[4].Compute("Sum(NoofFarmersc)", "").ToString() + "</td>");
        str.Append("<td style='text-align: Right; padding-right:5px;' >" + ds.Tables[5].Compute("Sum(NoofFarmerst)", "").ToString() + "</td>");
        str.Append("<td style='text-align: Right; padding-right:5px;' >" + ds.Tables[2].Compute("Sum(NoofFarmer)", "").ToString() + "</td>");
        str.Append("<td style='text-align: Right; padding-right:5px;' >" + ds.Tables[6].Compute("Sum(NoofFarmer)", "").ToString() + "</td>");
