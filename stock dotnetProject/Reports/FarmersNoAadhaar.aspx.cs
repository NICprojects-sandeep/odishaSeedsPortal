...
public partial class Reports_FarmersNoAadhaar : System.Web.UI.Page
{
    BLL_DropDown BAL;
    DLL_DropDown DAL;
    DataSet ds;
    ...
    {        
        ...
        {
            FillDistricts();
            //FillFarmers(Session["DistCode"].ToString());
        }
    }
    ...
    private void FillDistricts()
    {
        ...
        ddlDistrict.DataTextField = "vch_DistrictName";
        ddlDistrict.DataValueField = "Lgd_DistrictCode";
        ddlDistrict.DataBind();
        this.ddlDistrict.Items.Insert(0, "--Select--");        
    }
    ...
    protected void ddlDistrict_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            FillFarmers(ddlDistrict.SelectedValue.Trim());
        }
        else
        {
