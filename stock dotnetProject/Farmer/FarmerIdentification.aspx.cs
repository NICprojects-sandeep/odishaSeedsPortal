...
using System.IO;
public partial class FarmerIdentification : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            {
                if(ds.Tables[0].Rows[0]["INTRELATION"].ToString()=="1")
                {
                    lblFH.Text = "Father's Name";
                    Label1.Text = "Father's Name";
                }
                else
                {
                    lblFH.Text = "Husband's Name";
                    Label1.Text = "Husband's Name";
                }
