<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/BASAdmin.master" CodeFile="NicRejected.aspx.cs" Inherits="Admin_NicRejected" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="content-header">
      <h1>
         NIC REJECTED REQUESTS
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Admin</a></li>
        <li class="active"> NIC Rejected Requests</li>
      </ol>
    </section>
