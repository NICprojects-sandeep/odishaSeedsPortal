<%@ Page Title="::Price List::" Language="C#" MasterPageFile="~/MasterPages/Admin.master" AutoEventWireup="true" CodeFile="PriceList.aspx.cs" Inherits="Admin_PriceList" %>
                    ...
                    <td style="width: 40%;">
                        <table style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:DropDownList ID="ddlVarietyAge" runat="server" Width="200px" 
                                        AutoPostBack="True" onselectedindexchanged="ddlVarietyAge_SelectedIndexChanged">
                                        <asp:ListItem Text="Above_10_Year" Value="1"></asp:ListItem>
                                        <asp:ListItem Text="Below_10_Year" Value="0"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                             ...
                             <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtloadcharges" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td align="left">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtDealerCommission" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td align="left">
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtPacsCommission" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                             <tr>
                                <td align="left">
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtallincost" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                             <tr>
                                <td align="left">
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtgoiprice" runat="server"></asp:TextBox>
                                </td>
                                <tr>
                                <td align="left">
                                    SP Price
                            ...
                            <tr>
                                <td align="center" colspan="3">
                                    <br />
                                    <asp:GridView ID="gvCrop" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                                        AutoGenerateColumns="False" CellSpacing="2" Style="height: 138px">
                                        <AlternatingRowStyle BackColor="White" />
                                        <Columns>
                                            <asp:BoundField DataField="Variety_Code" HeaderText="Variety_Code" Visible="False" />
                                            ...
                                            <asp:BoundField DataField="Variety_Name" HeaderText="Variety_Name">
                            ...
                            <tr>
                                <td align="center" colspan="3">
                                    ...
                                    <fieldset style="width: 350px;">
                                        <asp:GridView ID="gvCrop1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                                            AutoGenerateColumns="False" CellSpacing="2" Width="300px">
                                            <AlternatingRowStyle BackColor="White" />
                                            <Columns>
            ...
            <asp:Panel ID="pnlEdit" runat="server" CssClass="modalPopup">
                <table style="width: 100%;" cellspacing="4">
                    <tr>
                        <td>
                            <p class="sansserif">
                                Are you sure to add these following crops for the seassion
                            ...
                            under the crop category
                            <asp:Label ID="lblCategoryName" runat="server" Font-Bold="True" ForeColor="#0099FF"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            ...
                            <asp:Panel ID="pnlSelected" runat="server" ScrollBars="Auto" Height="200px">
                                <fieldset>
                                    <asp:GridView ID="gvSelectedCrop" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CROP_CODE" HeaderText="Crop Code" Visible="False" />
                                            <asp:BoundField DataField="CROP_NAME" HeaderText="Crop Name" />
                                            <asp:BoundField DataField="Txt_Max_Qntl" HeaderText="Txt Max Qntl" />
                                        </Columns>
                                        <EditRowStyle BackColor="#7C6F57" />
                                        <FooterStyle BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
                                        <HeaderStyle BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
