<%@ Page Title="::Crop::" Language="C#" MasterPageFile="~/MasterPages/Admin.master" AutoEventWireup="true" CodeFile="Crop.aspx.cs" Inherits="Admin_Crop" %>
                            ...
                            <tr>
                                <td align="center" colspan="3">
                                    ...
                                    <asp:GridView ID="gvCrop" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="CROP_CODE" HeaderText="CROP_CODE" Visible="False" />
                                            <asp:TemplateField HeaderText="Select">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCropCode" runat="server" Text='<%# (Eval("CROP_CODE").ToString()) %>'
                                                        Visible="false" />
                                                    <asp:CheckBox ID="cbStatus" runat="server" Checked='<%# bool.Parse(Eval("IS_ACTIVE").ToString()) %>' />
                                                    <asp:Label ID="lblCropName" runat="server" Text='<%# (Eval("CROP_NAME").ToString()) %>'
                                                        Visible="false" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Max.Subsidy (In Qntl.)">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtmaxsusidy" runat="server"></asp:TextBox>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                            ...
                            <tr>
                                <td align="center" colspan="3">
                                    ...
                                    <fieldset style="width: 350px;">
                                        <asp:GridView ID="gvCrop1" runat="server" CellPadding="4" ForeColor="#333333"
