                    ...
                    <ContentTemplate>
                        ...
                        <table style="width: 80%; padding: 5px; flex-align: center">
                            ...
                            <tr runat="server" id="trGender">
                                <td align="left">&nbsp;</td>
                                <td align="left" runat="server" id="td14">
                                    &nbsp;</td>
                                <td style="color: #CC3300; font-size: xx-small"  align="right">Forced Gender Change By AAO :</td>
                                <td align="left" runat ="server" id="td15" style="font-size: xx-small; color: #3333CC">
                                    Subsidy availed Farm Machinary(<img src="../images/Right.jpg"  width="20px" height="15px"/>) <%--<br />
                                    Subsidy availed APICOL(<img src="../images/Right.jpg" width="20px" height="15px"/>)--%>
                                    </td>
                            </tr>
...
<asp:PostBackTrigger ControlID="btnGender0"></asp:PostBackTrigger>
<asp:PostBackTrigger ControlID="LinkGnd"></asp:PostBackTrigger>
                   </Triggers>
                   </asp:UpdatePanel>
            </div>
