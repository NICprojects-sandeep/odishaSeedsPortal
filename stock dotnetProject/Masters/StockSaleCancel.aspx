<%@ Page Title="::Sale Cancel::" Language="C#" MasterPageFile="~/MasterPages/STOCK.master" AutoEventWireup="true"
    CodeFile="StockSaleCancel.aspx.cs" Inherits="Masters_StockSaleCancel" %>
                ...
                <div>
                    <asp:UpdatePanel ID="upStockSALE" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtCashMemoNo" runat="server" Width="200px" Text="">
                                        </asp:TextBox>
                                    </td>
                                    <td>
                            ...
                            <hr />
                            <asp:GridView ID="gvCashMemoDtls" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                ForeColor="#333333" GridLines="None" Width="100%">
                                <AlternatingRowStyle BackColor="White" />
                                <Columns>
                                    <asp:TemplateField HeaderText="Transaction No" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lbtnSALETRANSID" runat="server"
                                                OnClick="lbtnSALETRANSID_Click">
                                                <%# Eval("SALETRANSID") %>
                                            </asp:LinkButton>
                                            <asp:Label ID="lblSALETRANSID" runat="server"
                                                Text='<%#Eval("SALETRANSID")%>' visible="false"></asp:Label>
                                            <asp:Label ID="lblGODOWN_ID" runat="server" Text='<%#Eval("GODOWN_ID")%>'
                                                visible="false"></asp:Label>
                                            <asp:Label ID="lblLIC_NO" runat="server" Text='<%#Eval("LIC_NO")%>'
                                                visible="false"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                        ...
                        text-align: left; vertical-align: top;" ScrollBars="Auto">
                                        <asp:Label ID="lblSALETRANSID1" runat="server" Text="" Visible="false">
                                        </asp:Label>
                                        <table style="width:100%">
                                            <tr>
                                                ...
                                                <td id="td_SALE_DATE" runat="server"
                                                    style="color:blue; font-weight: 700;"></td>
                                                <td>Licence No</td>
                                                <td>&nbsp;: </td>
                                                <td id="td_APP_FIRMNAME" runat="server"
                                                    style="color:blue; font-weight: 700;"></td>
                                            </tr>
                                            <tr>
                                                <td>Godown Name</td>
                                                ...
                                                <td id="td_GODOWN_NAME" runat="server"
                                                    style="color:blue; font-weight: 700;"></td>
                                                <td>Lot No</td>
                                                <td>&nbsp;: </td>
                                                <td id="td_LOTNO" runat="server" style="color:blue; font-weight: 700;">
                                                </td>
                                            </tr>
                                        </table>
                                        <hr />
                                        <table style="width: 100%">
                                            <tr>
                                                <td>
                                                    <fieldset>
                                                        <legend>
                                                            <asp:Label ID="lblSellerType" runat="server" /> SALE
                                                        </legend>
                                                        <table>
                                                            <tr>
                                                                <td>Bag Size
                                                ...
                                                <td>
                                                    <fieldset>
                                                        <legend>
                                                            <asp:Label ID="lblReceiverType" runat="server" /> Receive
                                                        </legend>
                                                        <table>
                                                            <tr>
                                                                <td>Bag Size
                                                ...
                                                <td>
                                                    <fieldset>
                                                        <legend>
                                                            <asp:Label ID="lblSeller" runat="server" />Stock
                                                        </legend>
                                                        <table>
                                                            <tr>
                                                                <td>Bag Size
                                                ...
                                                <td>
                                                    <fieldset>
                                                        <legend>
                                                            <asp:Label ID="lblReceiver" runat="server" />Stock
                                                        </legend>
                                                        <table>
                                                            <tr>
                                                                <td>Bag Size
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="btnCancel" runat="server"
                                                            Text="Cancel Transaction" OnClick="btnCancel_Click" />
                                                    </td>
                                                    <td>
                                    ...
                                    <%--<asp:UpdateProgress runat="server" ID="Uprogress"
                                        AssociatedUpdatePanelID="upStockSALE" DisplayAfter="0">
                                        <ProgressTemplate>
                                            <div style="text-align: center; vertical-align: middle; position: absolute; top: 0px; left: 0px; z-index: 99; width: 100%; height: 1000px; background-color: #ededed; -ms-filter: 'progid:DXImageTransform.Microsoft.Alpha(Opacity=60)'; filter: progid:DXImageTransform.Microsoft.Alpha(opacity=60); -moz-opacity: 0.8; opacity: 0.8;"
                                                visible="true">
                                                <div
                                                    style="width: 48px; height: 48px; margin: 0 auto; margin-top: 275px;">
                                                    <asp:Image ImageUrl="~/images/loading.gif" Width="48px"
                                                        Height="48px" runat="server" ID="TaskLoadingImage" />
                                                </div>
                                                <div
                                                    style="font-family: Trebuchet MS; font-size: 12px; color: Red; text-align: center;">
                                                    Please Wait ...
                                                </div>
                                            </div>
                                        </ProgressTemplate>
