...
public partial class Masters_UpdatePacs : System.Web.UI.Page
{
    ...
    private void FillPACS()
    {
        try
        {
            ...
            ds = new DataSet();
            ds = objUserDLL.FillDEPTPACS(objUserBEL);
            if (ds != null)
            {
    ...
    protected void btnConfirm_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            objUserBEL.NAME = lblDealerName.Text;
    ...
    protected void txtIFSC_TextChanged(object sender, EventArgs e)
    {
        ...
        {
            string strBnk = "SELECT A.INTBANKID,A.INTBRANCHID,B.VCHBANKNAME,A.VCHBRANCHNAME FROM M_PDS_BANKBRANCH A " +
