<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AAO_.master" AutoEventWireup="true" CodeFile="FarmerDetailsUpdate.aspx.cs" Inherits="Masters_FarmerDetailsUpdate" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <table style="width: 100%; padding: 7px; border:1px solid black">
                            ...
                            <tr runat="server" id="trGndrChange">
                                <td style="width:25%; color: #3399FF;" align="LEFT">Forced Gender Change?&nbsp;</td>
                                <td align="LEFT" colspan="2" style="width:50%">
                                   

                                    <asp:RadioButtonList ID="radGender" runat="server" Width="131px" AutoPostBack="True" OnSelectedIndexChanged="radGender_SelectedIndexChanged" RepeatDirection="Horizontal">
                                        <asp:ListItem Value="ao">Yes</asp:ListItem>
                                        <asp:ListItem Value="a1">No</asp:ListItem>
                                    </asp:RadioButtonList>
                                   

                                </td>
                                <td align="left" runat="server" id="td1" style="width:25%"></td>
                            ...
                            <tr>
                                ...
                                <td style="width:50%" align="center" colspan="2">&nbsp;
                                    <asp:Button ID="btnGender" runat="server" Text="Update" OnClick="btnGender_Click" BackColor="#999966" BorderColor="Maroon" Style="margin-left: 72px;" />
                                <asp:Button ID="btnGenderF" runat="server" Text="Reject"  BackColor="#999966" BorderColor="Maroon" Style="margin-left: 72px;" OnClick="btnGenderF_Click" /></td>
                            </tr>
                        </table>
                    </ContentTemplate>
                    <Triggers>
...
<asp:PostBackTrigger ControlID="btnGender"></asp:PostBackTrigger>
