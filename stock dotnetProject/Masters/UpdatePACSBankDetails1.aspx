<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/STOCK.master" AutoEventWireup="true" CodeFile="UpdatePACSBankDetails.aspx.cs" Inherits="Masters_UpdatePACSBankDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <br />
    <asp:GridView ID="gvPACS" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="170px" Width="600px" OnRowCommand="gvPACS_RowCommand">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Contact Number">
                <ItemTemplate>
                    <asp:Label ID="lbl_APPMOB_NO" runat="server" Text='<%#Eval("APPMOB_NO") %>'></asp:Label>
                </ItemTemplate>
                <ControlStyle Width="250px" />
                <FooterStyle Width="250px" />
                <HeaderStyle Width="250px" HorizontalAlign="Left" />
