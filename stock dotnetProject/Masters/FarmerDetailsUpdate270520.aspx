                ...
                <table style="width: 100%; padding:7px;border:1px solid black " >
                    ...
                    <tr>
                       <td style="width:25%"></td>
                        ...
                        <td style="width:50%" align="center" colspan="2">(Upload Scan Copy Of Aadhaar/Voter Id :<span style="color:red">*(.pdf&nbsp;file with 150kb)</span>) &nbsp;
                        ...
                        <table style="width: 100%; padding: 7px; border:1px solid black">
                            ...
                            <tr>
                                ...
                                <td style="width:50%" colspan="2" align="center">
                                    ...
                                    <br />(Upload Scan Copy Of Aadhaar/Voter Id :<span style="color:red">*(.pdf&nbsp;file with 150kb)</span>)
                                </td>
                                </ContentTemplate>
            ...
            <div style="background-color:white;" class="content">
                ...
                <table style="width: 100%; padding: 7px; border:1px solid black">
                    ...
                    <tr>
                        ...
                        <td align="center" colspan="2" style="width:50%">
                            <asp:TextBox ID="txtMobileNo" runat="server" onkeypress="return check(event);" BackColor="White" placeholder="Enter Mobile Number"></asp:TextBox>
        ...
        <ContentTemplate>--%>
                <table style="width: 100%; padding: 7px; border:1px solid black">
                    ...
                    <tr>
                        ...
                        <td align="left" runat="server" id="td2" style="width:25%"></td>
                        
                        <td align="center" style="width:50%" colspan="2">
                            <asp:TextBox ID="txtAadhaar" runat="server" BackColor="White" placeholder="Enter Adhar Number"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width:50%" colspan="2" align="center">(Upload Scan Copy Of Aadhaar:<span style="color:red">*(.pdf&nbsp;file with 150kb)</span>)
                ...
                <table style="width: 100%;padding: 7px;border:1px solid black">
                    ...
                    <tr>
                        ...
                        <td style="width:50%" colspan="2" align="center">
                            ...
                            <br />(Upload Scan Cast Certificate :<span style="color:red">*(.pdf&nbsp;file with 150kb)</span>)
                        </td>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                ...
                                <ContentTemplate>
                                    <tr>
                                        ...
                                        <td align="center" style="width:50%" colspan="2">
                                            <asp:FileUpload ID="updPassbook" runat="server"></asp:FileUpload><br />(Upload Scan Copy Of Passbook<span style="color:red">*(.pdf&nbsp; with 150kb)</span>)</td>
                                    </tr>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                            <tr><td colspan="4"><hr /></td></tr>
