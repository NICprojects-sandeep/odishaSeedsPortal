<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/AAO.master" CodeFile="EditGender.aspx.cs" Inherits="EditGender" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
    <h3>Edit Farmer Gender</h3>
                    ...
                    <td width="100%" >
                        <fieldset style="BORDER-RIGHT: #6f92ca 1px solid; BORDER-TOP: #6f92ca 1px solid; BORDER-LEFT: #6f92ca 1px solid; BORDER-BOTTOM: #6f92ca 1px solid" id="fldMain" runat="server">
                            ...
                            <table border="0" cellpadding="0" cellspacing="10" width="100%" class="text">
                                ...
                                <tr>
                                    <td class="auto-style1"><span class="b">7.</span>Gender<span class="c">*</span></td>
