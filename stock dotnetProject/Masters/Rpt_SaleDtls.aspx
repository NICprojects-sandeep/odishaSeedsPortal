<%@ Page Title="::Sale Details::" Language="C#" MasterPageFile="~/MasterPages/STOCK.master" AutoEventWireup="true" CodeFile="Rpt_SaleDtls.aspx.cs" Inherits="Masters_Rpt_SaleDtls" %>
                        ...
                        <asp:Panel ID="pnlContents" runat="server">
                            <asp:GridView ID="gvSaleDtls" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" OnRowCommand="gvSaleDtls_RowCommand">
                                ...
                                <asp:TemplateField HeaderText="Cash Memo No">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_APP_FIRMNAME" runat="server" Text='<%#Eval("APP_FIRMNAME")%>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Licence No">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_SALE_TO" runat="server" Text='<%#Eval("SALE_TO")%>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="DD/UTR Number">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_DD_NUMBER" runat="server" Text='<%#Eval("DD_NUMBER")%>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                </asp:TemplateField>
