...
public partial class Masters_Stock_ReceiveEntry : System.Web.UI.Page
{
        ...
        if (Cnt >= 0)// && ((Session["DistCode"].ToString() == "02") || (Session["DistCode"].ToString() == "09") || (Session["DistCode"].ToString() == "07")))
        {
            ...
            else
            {
                ...
                if (!this.Page.IsPostBack)
                {
                    ...
                    objUserDLL = new DLL_DropDown();
                    Session["SlNo"] = 1;
                    //bool IsReceive = objUserDLL.GetReceiveStatus(objUserBEL);
                    //if (IsReceive == false)
                    //{
                    ...
                    //StDaTe = DateTime.Now;
                    //DateTime to = StDaTe.Date.AddDays(0);
                    return;
                }
            }
        }
    ...
    protected void FillCropVariety()
    {
        try
        {
            ...
            else if (rbtn_class.SelectedValue == "Certified")
            {
                CropClass = "C03";
            }
            else if (rbtn_class.SelectedValue == "Breeder")
            {
                CropClass = "C04";
            }
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        if (str == 1)
                        {
                            ...
                            foreach (DataRow row in dt.Rows)
                            {
                                ...
                                objUserBEL1.cropName = cropName1;
                                objUserBEL1.varietyName = varietyName1;
                                ...
                                objUserBEL1.CropCatg_ID = row["CATEGORY_ID"].ToString();
